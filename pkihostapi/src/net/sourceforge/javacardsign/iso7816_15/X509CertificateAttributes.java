...
/** 
 * A structure to store ISO7816-15 X509CertificateAttributes objects.
 * Does not yet fully implement the specification.
 * @author Wojciech Mostowski <woj@cs.ru.nl>
 *
 */
public class X509CertificateAttributes {
    private int path;

    public X509CertificateAttributes(int path) {
        this.path = path;
    }

    public X509CertificateAttributes(InputStream in) {
