...
/** 
 * A structure to store ISO7816-15 CommonCertificateAttributes objects.
...
public class CommonCertificateAttributes {
    ...
    public CommonCertificateAttributes(byte[] authId) {
        this.authId = authId;
    }

    public CommonCertificateAttributes(InputStream in) {
